...
export default function HomeBadge() {
  return (
    <div className="group relative mb-2 inline-block rounded-full bg-slate-300 p-px text-xs leading-6 font-semibold no-underline shadow-2xl shadow-zinc-900 dark:bg-slate-900">
      ...
      <div className="ring-ring/10 relative z-10 flex items-center rounded-full bg-zinc-100 px-4 py-0.5 ring-1 dark:bg-zinc-950">
