/**
 * AudioStreamer for proper real-time audio playback
 * Based on the official Google Gemini Live API demo
 */

export class AudioStreamer {
  private sampleRate: number = 24000; // Gemini outputs at 24kHz
  ...
  /**
   * Add PCM16 audio data to the streaming queue
   */
